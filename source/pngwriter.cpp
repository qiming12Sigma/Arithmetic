...
pngwriter::pngwriter()
{
   ...
   textauthor_ = "PNGwriter";
   textdescription_ = "";
   textsoftware_ = "An easy to use graphics library.";
   texttitle_ = "out.png";
...
//PNGwriter should now be able to handle these color types:
...
unsigned char* pngwriter::getgraph(void)
{
	return *graph_;
}
